...
invitations_get_url = f'{api_url_prefix}/invitation/index'
...
#Get invitations
response = session.get(url=invitations_get_url, headers=api_headers, verify=False, timeout=30)
